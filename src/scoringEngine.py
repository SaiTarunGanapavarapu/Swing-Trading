...
def getCoverageSchema(isFinancial: bool) -> tuple[list[str], dict]:
    if isFinancial:
        coverageKeys = [
            "marketCapCr",
            "currentPrice",
    ...
    return coverageKeys, confidenceWeights
...
def scoreStock(data: dict) -> dict:
    ...
    coverageKeys, confidenceWeights = getCoverageSchema(isFinancial)
